...
async function main () {
  ...
  const wallet = Address.parse('0QAJq4apkkGqEo3vnNc2-04mckHGPaX19rb70YIf-y1zQavL');
  // Tonkeeper Testnet mode - tap 5 times on the Tonkeeper icon at the bottom of Settings to switch the network
  // Testnet wallet would not be shared with Mainnet
